...
void correccion(TUsuario &usu, TMaquina &maq){
    cout<<"Por el bien del juego, hemos hecho unos cambios en los valores de sus cartas los cuales no afectaran mucho.";
    do{
